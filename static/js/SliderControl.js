L.Control.SliderControl = L.Control.extend({
  ...
  onAdd: function (map) {
    ...
    $(sliderContainer).append(
      '<div id="leaflet-slider" style="width:600px; margin-left:60px; position:absolute; top:-55px"><div class="ui-slider-handle"></div><div id="slider-timestamp" style="width:200px; margin-top:13px; background-color:#FFFFFF; text-align:center; border-radius:5px;"></div></div>'
    );
    ...
    $("#leaflet-slider").slider({
      ...
      slide: function (e, ui) {
        ...
        if (!!_options.markers[ui.value]) {
          ...
          } else if (_options.markers[ui.value]._layers !== undefined) {
            if (
              _options.markers[ui.value]._layers[
                Object.keys(_options.markers[ui.value]._layers)[0]
              ].feature.properties[_options.timeAttribute]
            ) {
              if (_options.markers[ui.value])
                $("#slider-timestamp").html(
                  _extractTimestamp(
